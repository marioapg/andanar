              ...
              <form class="form" method="POST" action="{{ route('client.update') }}">
                ...
                <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                  <div class="input-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="{{ __('Nombre...') }}" value="{{ $client->name }}" required @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                  @if ($errors->has('name'))
                ...
                <div class="bmd-form-group{{ $errors->has('document') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" name="document" id="document" class="form-control" placeholder="{{ __('CIF/NIF/DNI...') }}" value="{{ $client->document }}" required @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                ...
                <div class="bmd-form-group{{ $errors->has('address') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" name="address" id="address" class="form-control" placeholder="{{ __('Dirección...') }}" value="{{ $client->address }}" required @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                ...
                <div class="bmd-form-group{{ $errors->has('postal_code') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" name="postal_code" id="postal_code" class="form-control" placeholder="{{ __('Código postal...') }}" value="{{ $client->postal_code }}" required @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                ...
                <div class="bmd-form-group{{ $errors->has('city') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" name="city" id="city" class="form-control" placeholder="{{ __('Ciudad...') }}" value="{{ $client->city }}" required @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                  @if ($errors->has('city'))
                ...
                <div class="bmd-form-group{{ $errors->has('state') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" name="state" id="state" class="form-control" placeholder="{{ __('Estado...') }}" value="{{ $client->state }}" required @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                  @if ($errors->has('state'))
                ...
                <div class="bmd-form-group{{ $errors->has('country') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" name="country" id="country" class="form-control" placeholder="{{ __('País') }}" value="{{ $client->country }}" required @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                ...
                <div class="bmd-form-group{{ $errors->has('phone') ? ' has-danger' : '' }} mt-3">
                  <div class="input-group">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control" placeholder="{{ __('Teléfono...') }}" value="{{ $client->phone }}" @if(!auth()->user()->hasRole('admin')) readonly @endif>
                  </div>
                  @if ($errors->has('phone'))
